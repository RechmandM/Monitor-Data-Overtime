        ...
        <div class="col">
            ...
            <section id="data" class="py-3">
                <div class="list-group-item mb-3 text-center" style="background-color: rgba(0, 0, 0, 0.2);">
                    <h2 class="list-inline-item text-primary fw-bold text-uppercase">Data User</h2>
                ...
                <div class="table-size table-scroll table-responsive bg-white" style="height: 270px">
                    ...
                    <table class="table table-bordered table-hover table-striped table-sm w-100" style="width:auto">
                        ...
                        <tbody>
                            <?php
                            $row = mysqli_query($conn, "SELECT * from user u  where lv=1 order by nama DESC");
                            $no = 1;
            ...
            <div class="container">
                <td>
                    <a class="text-white text-decoration-none" target="_blank" href="cetak.php"><button class="btn-primary w-100">EXPORT</button></a>
                </td>
            </div>
